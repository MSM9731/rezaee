...
<head>
    ...
    <link href="<?php echo ROOT ?>/app/assets/users/libs/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- iCheck -->
    <link href="<?php echo ROOT ?>/app/assets/users/libs/iCheck/skins/flat/green.css" rel="stylesheet">
    <!-- bootstrap-daterangepicker -->
    <link href="<?php echo ROOT ?>/app/assets/users/libs/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    ...
    <!-- Custom Theme Style -->
    <link href="<?php echo ROOT ?>/app/assets/users/css/custom.min.css" rel="stylesheet">
